...
class sensor_cluster(self):
    ...
    """
    def get_observation(self, log=True):
        # Clear transmissions
        ...
        if total_throughput == 0:
            ...
            return (similarity, self._throughputs, 0, 0, rates)
        ...
        clique_reward = 0.5 * (np.mean(max_clique_throughputs) / max_throughput - 1)
    ...
    def _send_observation_to_rl_agent(self):
    ...
    def _receive_rates_from_rl_agent(self):
        while(True):
            ...
            for sensor_idx in range(self._num_sensors):
                self.transmission_freq_idxs[sensor_idx] = rates[sensor_id]
